...
'''
* Most importantly, a test case should be created, in
...
from odemis.driver import picoquant400 as picoquant
import os
import time
import unittest
from odemis.driver import actuator, simulated # tmcm

print(picoquant.__file__)
...
HH400_KWARGS = dict(name="Time Correlator", role='time-correlator', device=None,
...
class TestHH400_Shutters(TestHH400):
    ...
    def setUpClass(cls):
        ...
        cls.dev = picoquant.HH400(children={'detector0': CONFIG_DET0, 'detector1': CONFIG_DET1},
